...
<?php $component->withAttributes([]); ?>
    <div class="fi-wi-stats-overview-card relative overflow-hidden rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
        ...
        <!-- Content -->
        <?php if($topDonaturs && $topDonaturs->count() > 0): ?>
            <div class="space-y-3">
                <?php $__currentLoopData = $topDonaturs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $donatur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center justify-between py-2">
                        <!-- Left side: rank and name -->
                        <div class="flex items-center gap-3 min-w-0 flex-1">
                            <!-- Rank badge -->
                            <div class="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold
                                <?php echo e($index === 0 ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400' : 
                            ...
                            <!-- Donatur name -->
                            <a href="<?php echo e($this->getDonaturUrl($donatur->id)); ?>" 
                        ...
                        <div class="text-right flex-shrink-0">
                            <div class="text-sm font-semibold text-gray-900 dark:text-white">
                                Rp <?php echo e(number_format($donatur->total_donasi, 0, ',', '.')); ?>

                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                <?php echo e($donatur->jumlah_transaksi); ?>x donasi
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /home/simadior/public_html/resources/views/filament/widgets/top-donatur-ringkas-widget.blade.php ENDPATH**/ ?>