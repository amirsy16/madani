...
<?php $component->withAttributes([]); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->showRequiresTwoFactorAlert()): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if (! ($user->hasEnabledTwoFactor())): ?>
        ...
        <?php else: ?>
            <!--[if BLOCK]><![endif]--><?php if($user->hasConfirmedTwoFactor()): ?>
                <h3 class="flex items-center gap-2 text-lg font-medium">
                ...
                <!--[if BLOCK]><![endif]--><?php if($showRecoveryCodes): ?>
                    <div class="px-4 space-y-3">
                        ...
                        <div>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->recoveryCodes->toArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /home/simadior/public_html/vendor/jeffgreco13/filament-breezy/src/../resources/views/livewire/two-factor-authentication.blade.php ENDPATH**/ ?>