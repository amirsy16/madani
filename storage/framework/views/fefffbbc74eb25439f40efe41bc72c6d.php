...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="form-number">No. <?php echo e($invoice_number ?? '24'); ?></div>
    ...
    <div class="main-section">
            ...
            <div class="date-left">
                <div class="form-field">
                    <div class="field-row">
                        ...
                        <div class="field-value"><?php echo e($donasi->tanggal_donasi ? $donasi->tanggal_donasi->format('d/m/Y') : date('d/m/Y')); ?></div>
                    </div>
                </div>
            </div>
        ...
        <div class="donor-section">
            <div class="form-field">
                <div class="field-row">
                    ...
                    <div class="field-value"><?php echo e($donatur->nama ?? 'N/A'); ?></div>
                </div>
            </div>
            ...
            <div class="form-field">
                <div class="field-row">
                    ...
                    <div class="field-value"><?php echo e($donatur->kode_donatur ?? 'N/A'); ?></div>
                </div>
            </div>
            ...
            <div class="form-field">
                <div class="field-row">
                    ...
                    <div class="field-value"><?php echo e($donatur->alamat_lengkap ?? 'N/A'); ?></div>
                </div>
            </div>
            ...
            <div class="form-field">
                <div class="field-row">
                    ...
                    <div class="field-value"><?php echo e($donatur->nomor_hp ?? 'N/A'); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="tax-section">
            ...
            <div class="form-field" style="margin-top: 5px;">
                <div class="field-row">
                    ...
                    <div class="field-value"><?php echo e($donatur->npwp ?? ''); ?></div>
                </div>
            </div>
            ...
            <div class="donation-content">
                <div class="donation-left">
                    ...
                    <div style="margin-bottom: 8px;">
                        <span class="checkbox <?php echo e($isZakat ? 'checked' : ''); ?>"><?php echo e($isZakat ? '✓' : ''); ?></span> zakat<br>
                        <span class="checkbox <?php echo e($isZakat ? 'checked' : ''); ?>"><?php echo e($isZakat ? '✓' : ''); ?></span> <span class="italic">zakah</span>
                    </div>
                    
                    <div style="margin-bottom: 8px;">
                        <span class="checkbox <?php echo e(($isInfak && !$isInfakDSKL) ? 'checked' : ''); ?>"><?php echo e(($isInfak && !$isInfakDSKL) ? '✓' : ''); ?></span> infak/ sedekah<br>
                        <span class="checkbox <?php echo e(($isInfak && !$isInfakDSKL) ? 'checked' : ''); ?>"><?php echo e(($isInfak && !$isInfakDSKL) ? '✓' : ''); ?></span> <span class="italic">donation</span>
                    </div>
                    
                    <div>
                        <span class="checkbox <?php echo e($isInfakDSKL ? 'checked' : ''); ?>"><?php echo e($isInfakDSKL ? '✓' : ''); ?></span> infak DSKL
                    </div>
                </div>
                <div class="donation-right">
                    <?php echo e($keterangan ?? $donasi->keterangan_infak_khusus ?? $donasi->catatan_donatur ?? ''); ?>
        ...
        <div class="payment-section">
            ...
            <div class="payment-content">
                <div class="payment-left">
                    ...
                    <div style="margin-bottom: 5px;">
                        <span class="checkbox <?php echo e($isCash ? 'checked' : ''); ?>"><?php echo e($isCash ? '✓' : ''); ?></span> tunai<br>
                        <span class="checkbox <?php echo e($isCash ? 'checked' : ''); ?>"><?php echo e($isCash ? '✓' : ''); ?></span> <span class="italic">cash</span>
                    </div>
                    
                    <div style="margin-bottom: 5px;">
                        <span class="checkbox <?php echo e($isTransfer ? 'checked' : ''); ?>"><?php echo e($isTransfer ? '✓' : ''); ?></span> transfer<br>
                        <span class="checkbox <?php echo e($isTransfer ? 'checked' : ''); ?>"><?php echo e($isTransfer ? '✓' : ''); ?></span> <span class="italic">transfer</span>
                    </div>
                    
                    <div style="margin-bottom: 5px;">
                        <span class="checkbox <?php echo e($isCekDebet ? 'checked' : ''); ?>"><?php echo e($isCekDebet ? '✓' : ''); ?></span> cek/ debet<br>
                        <span class="checkbox <?php echo e($isCekDebet ? 'checked' : ''); ?>"><?php echo e($isCekDebet ? '✓' : ''); ?></span> <span class="italic">cheque/ debit card</span>
                    </div>
                    
                    <div>
                        <span class="checkbox <?php echo e($isBarang ? 'checked' : ''); ?>"><?php echo e($isBarang ? '✓' : ''); ?></span> barang/ jasa<br>
                        <span class="checkbox <?php echo e($isBarang ? 'checked' : ''); ?>"><?php echo e($isBarang ? '✓' : ''); ?></span> <span class="italic">goods/ services</span>
                    </div>
                </div>
                <div class="payment-center">
                    <?php echo e($donasi->metodePembayaran->nama ?? 'N/A'); ?><br>
                    <?php if($donasi->metodePembayaran && $donasi->metodePembayaran->nomor_rekening): ?>
                        <?php echo e($donasi->metodePembayaran->nomor_rekening); ?>
            ...
            <div class="total-section">
                <span class="bold">TOTAL</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rp <?php echo e(number_format($donasi->jumlah, 0, ',', '.')); ?>
        ...
        <div class="words-section">
            ...
            <div class="words-box">
                ...
                ?>
                <?php echo e(ucwords(trim(terbilang($donasi->jumlah)))); ?> rupiah
            </div>
        </div>
    </div>
...
<?php /**PATH /home/simadior/public_html/resources/views/invoices/professional-donation-form.blade.php ENDPATH**/ ?>