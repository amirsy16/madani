...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['type' => 'submit','class' => 'bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700']); ?>
...
<?php endif; ?>
    ...
    <div class="space-y-8">
        ...
        <?php if($filteredReportData->count() > 0): ?>
        ...
        <div class="responsive-grid fade-in">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white currency">
                                Rp <?php echo e(number_format($totalPenerimaan, 0, ',', '.')); ?>
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white currency">
                                Rp <?php echo e(number_format($totalPenyaluran, 0, ',', '.')); ?>
                            ...
                            ?>
                            <div class="progress-bar mt-2">
                                <div class="progress-fill" style="width: <?php echo e(min($penyaluranPercentage, 100)); ?>%"></div>
                            </div>
                            <p class="text-xs text-gray-500 mt-1"><?php echo e(number_format($penyaluranPercentage, 1)); ?>% dari penerimaan</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="report-card">
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="icon-container mr-4" style="background: <?php echo e($totalSaldoAkhir >= 0 ? 'var(--success-green)' : 'var(--danger-red)'); ?>;">
                                <span class="text-white"><?php echo e($totalSaldoAkhir >= 0 ? '🏦' : '⚠️'); ?></span>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Sisa Saldo</p>
                            <p class="text-2xl font-bold <?php echo e($totalSaldoAkhir >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?> currency">
                                Rp <?php echo e(number_format(abs($totalSaldoAkhir), 0, ',', '.')); ?>

                            </p>
                            <span class="status-indicator <?php echo e($totalSaldoAkhir >= 0 ? 'status-positive' : 'status-negative'); ?>">
                                <?php echo e($totalSaldoAkhir >= 0 ? 'Surplus' : 'Defisit'); ?>
        ...
        <?php $__currentLoopData = $filteredReportData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fundKey => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="report-card fade-in">
                    ...
                    <div class="flex items-center justify-between relative z-10">
                        <div class="flex items-center">
                            <div class="icon-container mr-4">
                                <span><?php echo e(chr(64 + $loop->iteration)); ?></span>
                            </div>
                            <div>
                                <h2 class="text-2xl font-bold"><?php echo e(strtoupper($data['title'])); ?></h2>
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-2xl font-bold currency">
                                Rp <?php echo e(number_format($data['saldo_akhir'] ?? 0, 0, ',', '.')); ?>
                ...
                <div class="p-6">
                    ...
                    <?php if(isset($data['is_penyaluran_langsung']) && $data['is_penyaluran_langsung']): ?>
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-6 mb-6">
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-blue-600 dark:text-blue-400"><?php echo e($data['keterangan'] ?? 'Donasi langsung disalurkan oleh donatur'); ?></p>
                                </div>
                            </div>
                            
                            <?php if(isset($data['total_donasi_terdokumentasi']) && $data['total_donasi_terdokumentasi'] > 0): ?>
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        <span class="text-gray-700 dark:text-gray-300">Total Donasi Terdokumentasi:</span>
                                        <span class="font-bold text-blue-600 dark:text-blue-400">
                                            Rp <?php echo e(number_format($data['total_donasi_terdokumentasi'], 0, ',', '.')); ?>
                    ...
                    <div class="modern-table">
                        <table class="w-full">
                            <tbody>
                                ...
                                <?php if(!isset($data['is_penyaluran_langsung']) || !$data['is_penyaluran_langsung']): ?>
                                    ...
                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3 text-right font-bold currency text-blue-600 dark:text-blue-400">
                                            Rp <?php echo e(number_format($data['saldo_awal'] ?? 0, 0, ',', '.')); ?>
                                ...
                                <!-- Rincian Penerimaan -->
                                <?php if(isset($data['rincian_penerimaan']) && count($data['rincian_penerimaan']) > 0): ?>
                                    <?php $__currentLoopData = $data['rincian_penerimaan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis => $jumlah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="px-4 py-2 text-right currency font-semibold text-green-600 dark:text-green-400">
                                                Rp <?php echo e(number_format($jumlah, 0, ',', '.')); ?>
                                    ...
                                    <tr class="border-t-2 border-green-200 dark:border-green-700">
                                        ...
                                        <td class="px-4 py-3 text-right font-bold text-lg currency text-green-600 dark:text-green-400">
                                            <?php if(isset($data['is_penyaluran_langsung']) && $data['is_penyaluran_langsung']): ?>
                                                Rp <?php echo e(number_format($data['total_donasi_terdokumentasi'] ?? 0, 0, ',', '.')); ?>

                                            <?php else: ?>
                                                Rp <?php echo e(number_format($data['penerimaan'], 0, ',', '.')); ?>
                                    ...
                                    <?php if(!isset($data['is_penyaluran_langsung']) || !$data['is_penyaluran_langsung']): ?>
                                        <?php if(isset($data['bagian_amil']) && $data['bagian_amil'] > 0 && strtolower($data['title']) !== 'hak amil'): ?>
                                            <tr>
                                                <td class="px-4 py-2 pl-8 text-orange-700 dark:text-orange-300">
                                                    ...
                                                    <span class="inline-flex items-center">
                                                        ...
                                                        Dikurangi: Bagian Amil (<?php echo e(number_format($persentaseHakAmil, 1)); ?>%)
                                                    </span>
                                                </td>
                                                <td class="px-4 py-2 text-right currency font-semibold text-orange-600 dark:text-orange-400">
                                                    (Rp <?php echo e(number_format($data['bagian_amil'], 0, ',', '.')); ?>)
                                                </td>
                                            </tr>
                                            <tr class="border-t border-gray-200 dark:border-gray-700">
                                                ...
                                                <td class="px-4 py-3 text-right font-bold currency text-blue-600 dark:text-blue-400">
                                                    Rp <?php echo e(number_format(($data['penerimaan'] ?? 0) - ($data['bagian_amil'] ?? 0), 0, ',', '.')); ?>
                                ...
                                <?php if(isset($data['rincian_penyaluran_asnaf']) && count($data['rincian_penyaluran_asnaf']) > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $data['rincian_penyaluran_asnaf']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asnaf => $jumlah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                ...
                                <?php if(isset($data['rincian_penyaluran_bidang']) && count($data['rincian_penyaluran_bidang']) > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $data['rincian_penyaluran_bidang']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bidang => $jumlah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="px-4 py-2 pl-12 text-gray-700 dark:text-gray-300">
                                                <span class="inline-flex items-center">
                                ...
                                <tr class="border-t-2 border-red-200 dark:border-red-700">
                                    ...
                                    <td class="px-4 py-3 text-right font-bold text-lg currency text-red-600 dark:text-red-400">
                                        Rp <?php echo e(number_format($data['penyaluran'] ?? 0, 0, ',', '.')); ?>
                                ...
                                <tr class="border-t-4 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
                                    ...
                                    <td class="px-4 py-4 text-right">
                                        <div class="flex items-center justify-end">
                                            ...
                                            <?php else: ?>
                                                <span class="text-2xl font-bold currency <?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                                    Rp <?php echo e(number_format(abs($data['saldo_akhir'] ?? 0), 0, ',', '.')); ?>

                                                </span>
                                                <span class="ml-2 status-indicator <?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? 'status-positive' : 'status-negative'); ?>">
                                                    <?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? 'Surplus' : 'Defisit'); ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="mt-6 p-4 rounded-lg <?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? 'bg-green-50 dark:bg-green-900/20' : 'bg-red-50 dark:bg-red-900/20'); ?>">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <div class="icon-container mr-3" style="background: <?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? 'var(--success-green)' : 'var(--danger-red)'); ?>;">
                                        <span class="text-white"><?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? '✅' : '⚠️'); ?></span>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold <?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200'); ?>">
                                            Status Kesehatan Dana
                                        </h4>
                                        <p class="text-sm <?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                            <?php echo e(($data['saldo_akhir'] ?? 0) >= 0 ? 'Dana dalam kondisi sehat dengan saldo positif' : 'Perlu perhatian: Saldo defisit'); ?>
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-lg font-bold <?php echo e($utilizationRate >= 80 ? 'text-green-600' : ($utilizationRate >= 50 ? 'text-yellow-600' : 'text-red-600')); ?>">
                                        <?php echo e(number_format($utilizationRate, 1)); ?>%
                                    </p>
                                    <div class="progress-bar mt-1" style="width: 100px;">
                                        <div class="progress-fill <?php echo e($utilizationRate >= 80 ? 'positive' : ($utilizationRate >= 50 ? '' : 'negative')); ?>" 
                                             style="width: <?php echo e(min($utilizationRate, 100)); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex items-center justify-between relative z-10">
                    ...
                    <div class="text-right">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-white/20 text-white">
                            <?php echo e($totalSaldoAkhir >= 0 ? '✅ Sehat' : '⚠️ Perlu Perhatian'); ?>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                        ...
                        ?>
                        <div class="progress-bar mt-3">
                            <div class="progress-fill" style="width: <?php echo e(min($overallPercentage, 100)); ?>%"></div>
                        </div>
                        <p class="text-xs text-blue-600 dark:text-blue-400 mt-2">
                            <?php echo e(number_format($overallPercentage, 1)); ?>% dari penerimaan
                        </p>
                    </div>

                    <!-- Sisa Saldo -->
                    <div class="text-center p-6 <?php echo e($totalSaldoAkhir >= 0 ? 'bg-green-50 dark:bg-green-900/20' : 'bg-red-50 dark:bg-red-900/20'); ?> rounded-xl">
                        <div class="icon-container mx-auto mb-4" style="background: <?php echo e($totalSaldoAkhir >= 0 ? 'var(--success-green)' : 'var(--danger-red)'); ?>;">
                            <span class="text-white"><?php echo e($totalSaldoAkhir >= 0 ? '🏦' : '⚠️'); ?></span>
                        </div>
                        <h3 class="text-sm font-medium <?php echo e($totalSaldoAkhir >= 0 ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200'); ?> mb-2">
                            Sisa Saldo
                        </h3>
                        <p class="text-3xl font-bold <?php echo e($totalSaldoAkhir >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?> currency">
                            Rp <?php echo e(number_format(abs($totalSaldoAkhir), 0, ',', '.')); ?>

                        </p>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium mt-3 <?php echo e($totalSaldoAkhir >= 0 ? 'status-positive' : 'status-negative'); ?>">
                            <?php echo e($totalSaldoAkhir >= 0 ? 'SURPLUS' : 'DEFISIT'); ?>
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
                        ...
                        <p class="text-xl font-bold <?php echo e($overallPercentage >= 80 ? 'text-green-600' : ($overallPercentage >= 50 ? 'text-yellow-600' : 'text-red-600')); ?>">
                    ...
                    <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
                        ...
                        <p class="text-xl font-bold text-blue-600 dark:text-blue-400">
                            <?php echo e($filteredReportData->count()); ?>
                    ...
                    <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
                        ...
                        <p class="text-xl font-bold text-gray-900 dark:text-white currency">
                            Rp <?php echo e($filteredReportData->count() > 0 ? number_format($totalSaldoAkhir / $filteredReportData->count(), 0, ',', '.') : '0'); ?>
                    ...
                    <div class="bg-white dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
                        ...
                        <p class="text-sm font-bold text-gray-900 dark:text-white">
                            <?php echo e(Carbon\Carbon::parse($startDate)->diffInDays(Carbon\Carbon::parse($endDate)) + 1); ?> Hari
                        </p>
                    </div>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH /home/simadior/public_html/resources/views/filament/pages/laporan-perubahan-dana.blade.php ENDPATH**/ ?>