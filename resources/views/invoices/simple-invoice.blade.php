        ...
        <div class="main-content">
            <div class="left-section">
                ...
                <div class="invoice-info">
                    ...
                    <em>Invoice {{ $transactionType }} - Terima kasih atas amanah Anda</em>
                </div>
                ...
                <div class="field-group">
                    <div class="field-label">Nama {{ $personLabel }}</div>
                    <div class="field-value">{{ $nama }}</div>
                </div>
                
                <div class="field-group">
                    <div class="field-label">ID {{ $personLabel }}</div>
                    <div class="field-value">{{ $donaturId }}</div>
                </div>
                ...
                <div class="method-badges">
                    <div class="method-badge {{ strtolower($metodePembayaran) === 'tunai' || strtolower($metodePembayaran) === 'cash' ? 'active' : 'inactive' }}">
                        💰 Tunai
                    </div>
                    <div class="method-badge {{ stripos($metodePembayaran, 'transfer') !== false || stripos($metodePembayaran, 'bank') !== false ? 'active' : 'inactive' }}">
                        🏦 Transfer
                    </div>
                    <div class="method-badge {{ stripos($metodePembayaran, 'card') !== false || stripos($metodePembayaran, 'debit') !== false ? 'active' : 'inactive' }}">
                        💳 Kartu
                    </div>
                </div>
            </div>
                ...
                <table class="transaction-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $isZakat ? 'Rp ' . number_format($jumlahNumeric, 0, ',', '.') : '' }}</td>
                        </tr>
                        <tr>
                            <td>{{ !$isZakat ? '✓' : '○' }} Infaq/Sedekah</td>
                            <td>{{ !$isZakat ? $jenisTransaksi : '' }}</td>
                            <td>{{ !$isZakat ? 'Rp ' . number_format($jumlahNumeric, 0, ',', '.') : '' }}</td>
                        </tr>
                    </tbody>
